...
const automatedSwapController_1 = require("../controllers/automatedSwapController");
 ...
 */
router.post('/start', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.startAutomatedSwaps);
/**
 * @openapi
 ...
 */
router.post('/stop', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.stopAutomatedSwaps);
/**
 * @openapi
 ...
 *                       type: string
 */
router.get('/status', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.getAutomatedSwapStatus);
/**
 * @openapi
 ...
 *                   type: object
 */
router.get('/health', automatedSwapController_1.getSystemHealth);
/**
 * @openapi
 ...
 *                         type: string
 */
router.get('/queue', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.getSwapQueue);
/**
 * @openapi
 ...
 */
router.post('/manual/:exchangeId', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.triggerManualSwap);
/**
 * @openapi
 ...
 *         description: Exchange not found
 */
router.post('/test/:exchangeId', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.testAutomatedSwap);
/**
 * @openapi
 ...
 */
router.post('/monitor', authMiddleware_1.protect, authMiddleware_1.isAdmin, automatedSwapController_1.addMonitoredAddress);
