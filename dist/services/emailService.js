...
exports.sendCorridorConfirmationEmail = exports.sendWelcomeEmail = exports.sendEmailVerification = exports.sendAdminSupportEmail = exports.sendPasswordResetConfirmation = exports.sendPasswordResetEmailWithToken = exports.sendPasswordResetEmail = exports.generateEmailVerificationToken = exports.generateVerificationCode = void 0;
...
const sendPasswordResetEmailWithToken = (email, resetToken) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transporter = createTransporter();
...
exports.sendPasswordResetEmailWithToken = sendPasswordResetEmailWithToken;
const sendPasswordResetConfirmation = (email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transporter = createTransporter();
        const mailOptions = {
            from: process.env.SMTP_USER || 'admin@ledgerswap.io',
...
const sendAdminSupportEmail = (subject, message, fromEmail) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendAdminSupportEmail = sendAdminSupportEmail;
// Send email verification email
const sendEmailVerification = (email, verificationToken) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transporter = createTransporter();
...
const sendCorridorConfirmationEmail = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transporter = createTransporter();
        const mailOptions = {
            from: process.env.SMTP_USER || 'admin@ledgerswap.io',
...
exports.sendCorridorConfirmationEmail = sendCorridorConfirmationEmail;
