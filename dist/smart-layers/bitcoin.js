...
exports.createBitcoinEscrow = createBitcoinEscrow;
exports.releaseBitcoinEscrow = releaseBitcoinEscrow;
 ...
 */
function releaseBitcoinEscrow(psbt, inputIndex, spendingKeys, redeem) {
    ...
    psbt.finalizeInput(inputIndex, (inputIndex, input) => {
        ...
        const signatures = input.partialSig.map((p) => p.signature);
