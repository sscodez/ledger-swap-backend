...
const createSampleBlog = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, db_1.default)();
        console.log('Connected to database');
        // Check if any blogs exist
        const existingBlogs = yield Blog_1.default.countDocuments();
        console.log(`Found ${existingBlogs} existing blogs`);
        if (existingBlogs > 0) {
            console.log('Blogs already exist, listing them:');
            const blogs = yield Blog_1.default.find().populate('author', 'name email').lean();
...
exports.default = createSampleBlog;
