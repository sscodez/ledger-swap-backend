...
exports.executeEmailCommand = exports.getEmailServiceConfig = exports.sendTestEmail = exports.checkEmailServiceHealth = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const emailService_1 = require("../services/emailService");
// Email service health check
const checkEmailServiceHealth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.checkEmailServiceHealth = checkEmailServiceHealth;
// Send test email
    ...
    try {
        ...
        switch (type) {
            case 'password_reset':
                ...
                result = yield (0, emailService_1.sendPasswordResetEmail)(to, resetCode);
                emailType = 'Password Reset';
                break;
            case 'email_verification':
                const verificationToken = (0, emailService_1.generateEmailVerificationToken)();
                result = yield (0, emailService_1.sendEmailVerification)(to, verificationToken);
                emailType = 'Email Verification';
                break;
            case 'welcome':
                result = yield (0, emailService_1.sendWelcomeEmail)(to, 'Test User');
                emailType = 'Welcome Email';
                break;
            case 'support':
                const supportResult = yield (0, emailService_1.sendAdminSupportEmail)(subject || 'Test Support Email', message || 'This is a test support email from the API.', to);
...
const getEmailServiceConfig = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const smtpHost = 'smtp.titan.email';
        const smtpPort = 587;
        const smtpUser = "admin@ledgerswap.io";
...
exports.getEmailServiceConfig = getEmailServiceConfig;
// Execute email command (batch operations)
const executeEmailCommand = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        switch (command) {
            case 'health_check':
                ...
                return (0, exports.checkEmailServiceHealth)(req, res);
            case 'send_bulk_test':
                ...
                for (const recipient of recipients) {
                    try {
                        ...
                        if (emailType === 'test') {
                            const resetCode = (0, emailService_1.generateVerificationCode)();
                            sendResult = yield (0, emailService_1.sendPasswordResetEmail)(recipient, resetCode);
                        }
                        bulkResults.push({
                            recipient: recipient,
                            success: sendResult,
...
exports.executeEmailCommand = executeEmailCommand;
